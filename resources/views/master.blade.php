  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <form id="search-form" class="form-inline ml-3" action="/search" method="get">
      <div class="input-group input-group-sm">
        <input id="search-content" name="query" class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#" role="button" style="display:none"><i
